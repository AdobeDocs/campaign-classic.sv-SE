...
>[!NOTE]
>
>Mer information om sekretess- och säkerhetsbestämmelser för Adobe Camera finns i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/sv/docs/campaign/campaign-v8/privacy/security){target=_blank}.
