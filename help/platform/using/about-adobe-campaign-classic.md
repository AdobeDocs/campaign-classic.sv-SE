...
>[!AVAILABILITY]
>
>* Hjälpmaterialet i den här samlingen gäller för Campaign Classic v7 i den [senaste versionen](../../rn/using/latest-release.md). Ett specifikt märke finns när ett avsnitt också gäller Campaign v8.
>
