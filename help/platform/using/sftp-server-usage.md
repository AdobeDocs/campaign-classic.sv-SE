...
1. Felsök **sessionsloggar**:
   ...
   1. Dubbelklicka på aktiviteten [Filöverföring](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/event-activities/file-transfer.html?lang=sv-SE){target="_blank"} i arbetsflödet.
