...
* [Alternativ för självhjälp](../../platform/using/tutorials.md#how-to-videos)
...
## 6. Hur ansluter jag till Campaign Classicen? {#how-can-i-connect-to-campaign-classic-}
...
## 7. Vilka system- och komponentsystem är kompatibla med Campaign Classicen? {#which-systems-and-components-campaign-classic-is-compatible-with-}
...
## 8. Var finns Campaign Classicens versionsinformation? {#where-are-campaign-classic-release-notes-}
