...
Läs mer om [A/B-testning](../../delivery/using/get-started-a-b-testing.md).
+++
...
Läs mer om målgrupper i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-target.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om kampanjer i dokumentationen för [Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaigns/campaigns.html?lang=sv-SE){target=_blank}.
+++
...
Campaign-klientkonsolen är en avancerad klient som gör att du kan ansluta till dina Campaign-programservrar. Det körbara programmet (.exe) för klientkonsolen installeras på en dator med ett operativsystem för Microsoft Windows. Campaign Client console centraliserar alla funktioner och inställningar.

Läs mer om [klientkonsolen](../../platform/using/adobe-campaign-workspace.md).
+++
...
Läs mer om godkännande av innehåll i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-approval.html?lang=sv-SE){target="_blank"}.
...
Läs mer om kontrollgrupper i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-target.html?lang=sv-SE#add-a-control-group){target="_blank"}.
+++
...
Läs mer om [Kontrollpanelen](https://experienceleague.adobe.com/docs/control-panel/using/discover-control-panel/key-features.html?lang=sv-SE).
+++

+++**Kuber**

*Kontext: Marknadsföringsanalys*
...
Adobe Campaign levereras med en fördefinierad datamodell, där datatyper definieras genom installation av olika paket. Operatörer kan förbättra datamodellen som tillhandahålls genom att utöka resurserna för att lägga till anpassade fält eller anpassade tabeller, som transaktioner eller produkttabeller.

Läs mer om [Anpassade resurser](../../configuration/using/about-schema-edition.md).
+++
...
Läs mer om [Databasrensningsarbetsflöde](../../production/using/database-cleanup-workflow.md).
+++
...
En leverans är ett specifikt marknadsföringskommunikationsobjekt som skickas till en viss målgrupp via en viss kanal (e-post, SMS, push-meddelanden osv.). Kallas också&quot;touch&quot; i marknadsföringsterminologi.

Läs mer om [Leveranser](../../delivery/using/communication-channels.md).
+++
...
Läs mer om leveransanalys i [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/validate/delivery-analysis.html?lang=sv-SE){target="_blank"}.
+++

+++**Leveransloggar**

Leveransloggar innehåller information som genereras när ett meddelande skickas. Dessa loggar visar detaljerna för sändningen, vilket meddelande som har förberetts, ignorerats, skickats eller misslyckats. De kan nås direkt från kontrollpanelen för leverans.

Läs mer om [Leveransloggar](https://experienceleague.adobe.com/sv/docs/campaign/campaign-v8/send/monitor/delivery-dashboard#delivery-logs-and-history){target="_blank"}.
+++
...
Läs mer om distribuerad marknadsföring i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om [Distribution av värden](../../platform/using/adobe-campaign-workspace.md#about-queries-in-campaign)
+++

+++**Domändelegering**

Med subdomänkonfigurationen kan du konfigurera en undersektion till din domän (tekniskt en &quot;DNS-zon&quot;) för användning med Adobe Campaign.
Med domändelegering kan Adobe styra och underhålla alla aspekter av DNS som krävs för att leverera, återge och spåra e-postkampanjer.

Läs mer om [Domändelegering](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=sv-SE)
+++
...
Läs mer om [Kvalifikationsregler](../../interaction/using/interaction-and-offer-management.md).
+++
...
Läs mer om Enrichment-aktiviteten i [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/enrichment.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om trötthetshantering i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/pressure-rules.html?lang=sv-SE){target="_blank"}.
+++
...
Lär dig mer om [Åtkomst till federerade data](../../installation/using/about-fda.md).
+++

+++**Godkännande av filextrahering**
...
Läs mer om filtreringsdimensionen i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/wf-type/targeting-workflows.html?lang=sv-SE#targeting-and-filtering-dimensions){target="_blank"}.
+++
...
Forms definierar gränssnittsrepresentationen för en viss schematyp. Forms är ett sätt att enkelt skapa och redigera dataelement i produkten, till exempel mottagare, leveranser och kampanjer. Alla gränssnittselement i Adobe Campaign skapas i själva produkten med Forms. Observera att formulär är valfria och inte alla scheman har formulär.
...
Se [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/heatmap.html?lang=sv-SE){target="_blank"}.
+++
...
* **anonym**: kontakten kan inte identifieras.
...
Läs mer om [Inkommande interaktion](../../interaction/using/about-inbound-channels.md).
+++

+++**Återgivning av inkorgen**

Inkorgsåtergivning är en generering av förhandsgranskningar av e-postmeddelanden, som ser till att meddelandet visas för mottagarna på ett optimalt sätt på ett antal webbklienter, webbmejl och enheter. Adobe Campaign utnyttjar Litmus, som gör att skribenter av e-postinnehåll kan förhandsgranska sitt meddelandeinnehåll i över 70 e-postrenderare, till exempel Gmail-inkorgen eller Apple Mail-klienten.

Läs mer om [Inkorgsåtergivning](../../delivery/using/inbox-rendering.md).
+++
...
En lista är en statisk datamängd. Listor är målgrupper eller segment som importeras till Campaign från andra källor (Audience Manager, Experience Platform, databas, osv.) och som i gränssnittet visas som importerade listor.
...
Läs mer om [Lokal cache](../../platform/using/faq-campaign-classic-v7.md#how-do-i-clear-console-cache).
+++
...
Läs mer om MRM i [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/mrm/about-marketing-resource-management.html?lang=sv-SE){target="_blank"}.
+++
...
De detaljerade åtkomsträttigheter för databaser som används för att definiera operatörsgruppåtkomst och behörigheter (roller). Namngivna rättigheter fylls i under installationen av produkten och genom att olika paket importeras som definierar en specifik funktion för verktyget. Anpassade namngivna rättigheter kan skapas som stöd för kundens affärskrav.

Läs mer om [Namngivna rättigheter](../../platform/using/access-management-named-rights.md).
+++
...
Läs mer om mål i [Adobe Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/mrm/creating-and-managing-tasks.html?lang=sv-SE#expenses-and-revenues){target=_blank}.
+++
...
Offer Live-miljön är länkad till en Campaign **Design-miljö**. Den innehåller skrivskyddade erbjudanden vars innehåll och behörighet har godkänts via **designmiljön**. De kan väljas för presentation på en webbplats eller infogas i ett utgående meddelande.

Läs mer om [Erbjud Live-miljöer](../../interaction/using/fundamental-principles.md).
+++

+++**Erbjud presentationsregler**
...
Läs mer om [Erbjud presentationsregler](../../interaction/using/managing-offer-presentation.md#presentation-rules-overview).
+++
...
Läs mer om [Erbjudandeerbjudanden](../../interaction/using/creating-offer-spaces.md#offer-proposition-statuses).
+++
...
En offertrepresentation är information som används av kanalen för att visa erbjudandet. Erbjudanderepresentationen kan skapas med hjälp av återgivningsfunktionen i det utrymme som erbjudandet avser eller anges direkt i gränssnittet (t.ex. i HTML-blocket). Ett erbjudande kan representeras av ett space.

Läs mer om [Interaktion](../../interaction/using/interaction-and-offer-management.md).
+++

+++**Erbjudandesimulering**
...
Läs mer om [Erbjudandeutrymme](../../interaction/using/creating-offer-spaces.md).
+++
...
Läs mer om [Erbjud teman](../../interaction/using/integrating-an-offer-via-the-wizard.md).
+++
...
Läs mer om [Operator groups](../../platform/using/access-management-groups.md).
+++

+++**Alternativ**

Alternativ är plattformsnivåvariabler som används för att definiera inställningar för Campaign-instansen. Alternativ kan definiera tidsramar (t.ex. för arbetsflöde vid databasrensning) eller andra globala definitioner på plattformsnivå.

Läs mer om [Alternativ](../../installation/using/configuring-campaign-options.md).
+++
...
Läs mer om [Utgående interaktion](../../interaction/using/about-outbound-channels.md).
+++

+++**Paketexport/import**

En paketexport är en åtgärd som består av att generera en XML-fil som innehåller objektdefinitioner. Paket används för att migrera funktioner och definitioner från en instans till en annan. De används också för att lägga till viktiga produktdefinitioner i system för säkerhetskopiering och källkontroll.

Läs mer om [Paketexport/import](../../platform/using/working-with-data-packages.md).
+++
...
Läs mer om paletten i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=sv-SE#add-and-link-activities){target="_blank"}.
+++

+++**Prestandaövervakning**

Information om prestandaövervakning visas på fliken Övervakning. Här visas mätvärden för det underliggande systemet, t.ex. minnes- och CPU-användning, statistik för SMTP-servrar, serverprocesser och annan relevant information.

Läs mer om [Prestandaövervakning](../../production/using/monitoring-processes.md).
+++
...
Läs mer om personaliseringsblock i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/personalize/personalization-blocks.html?lang=sv-SE){target="_blank"}.
+++

+++**Personalization-fält**
...
Läs mer om anpassningsfält i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/personalize/personalization-fields.html?lang=sv-SE){target="_blank"}.
+++

+++**Personalization-variabler**

Personalization-variabler är koddelar i en leverans som kan visa olika text för olika mottagare baserat på mottagarens information. Dessa fält kan implementeras som antingen ett personaliseringsfält eller -block.

Läs mer om [Personalization-variabler](../../delivery/using/about-personalization.md).
+++
...
Läs mer om planer i dokumentationen för [Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/set-up-campaigns.html?lang=sv-SE){target=_blank}.
+++
...
Läs mer om program i dokumentationen för [Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/set-up-campaigns.html?lang=sv-SE){target=_blank}.
+++
...
Läs mer om [Push](../../delivery/using/about-mobile-app-channel.md).
+++
...
Läs mer om [Återgivningsfunktionen](../../interaction/using/creating-offer-spaces.md).
+++
...
Seed-adresser används för målmottagare som inte matchar de definierade målvillkoren. På så sätt kan mottagare som ligger utanför leveransomfånget ta emot leveransen, precis som andra målmottagare gör. De läggs till i målgruppen för ett meddelande för att upptäcka om mottagardatabasen används på ett bedrägligt sätt eller för att säkerställa leveransen.

Läs mer om [dirigeringsadresser](../../delivery/using/about-seed-addresses.md).
+++
...
Med Adobe Campaign kan du skapa och administrera informationstjänster som nyhetsbrev och produktuppdateringar och hantera prenumerationer på dessa tjänster. Flera tjänster kan definieras parallellt.

Läs mer om [Tjänster](../../delivery/using/about-services-and-subscriptions.md).
+++
...
Läs mer om prenumerationstjänstaktiviteten i [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/subscription-services.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om aktiviteten för målgodkännande i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/approval.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om måldata i [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/use-workflow-data.html?lang=sv-SE#target-data){target="_blank"}.
+++
...
Läs mer om målmappning i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/audience/add-profiles/target-mappings.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om målgruppsdimensionen i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/wf-type/targeting-workflows.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om aktiviteten Fråga i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/mrm/creating-and-managing-tasks.html?lang=sv-SE){target="_blank"}.
+++
...
En mall är ett designelement som används för att skapa ett objekt. Den innehåller objektinställningar och eventuellt objektets innehåll. Mallsystemet används för att skapa leveranser, kampanjer, arbetsflöden och många andra element i Adobe Campaign. De tillgängliga fabriksmallarna definieras av de installerade paketen. Mallar kan sedan dupliceras och anpassas efter behov av kampanjansvariga.
+++
...
Det tekniska arbetsflödet för spårning hämtar spårningsdata när leveransen har skickats och spårningen har aktiverats. Dessa data finns på fliken Spårning för leveransen. Du kan söka efter information om öppningar och klick i ett e-postmeddelande eller andra interaktioner med ett meddelande som mottagaren har fått.

Läs mer om [spårningsloggar i Campaign v8](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracking-logs){target="_blank"}.
+++

+++**Transaktionsmeddelanden**

Transactional messaging är en Campaign-modul som är utformad för att hantera anpassade utlösarmeddelanden som genereras från händelser som skickas av ett externt informationssystem. Ett transaktionsmeddelande är en individ och en unik kommunikation som skickas i realtid av en leverantör, till exempel en webbplats. Det är särskilt väntat eftersom det innehåller viktig information som mottagaren vill kontrollera eller bekräfta.
...
Läs mer om utlösta kampanjer i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/external-signal.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om typologier i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om typologiregler i dokumentationen för [Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=sv-SE){target="_blank"}.
+++
...
*Kontext: Kampanjinteraktion, transaktionsmeddelanden*

I enskärmsläge bearbetas en enskild kontakt av erbjudandemotorn vid körning. Det här läget används vanligtvis för inkommande interaktioner och transaktionsmeddelanden.
...
Ett arbetsflöde är en visuell representation av kampanjens körningsflöde. Det gör att du kan samordna alla processer och uppgifter i olika moduler på programservern. I den omfattande grafiska miljön kan ni utforma processer som segmentering, kampanjhantering, filhantering, medarbetare osv. Arbetsflödesmotorn kör och spårar dessa processer.
...
Läs mer om arbetsflödesjournalen i [Campaign v8-dokumentationen](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution.html?lang=sv-SE){target="_blank"}.
+++
...
Läs mer om [arbetstabeller](../../workflow/using/about-workflows.md).
+++
