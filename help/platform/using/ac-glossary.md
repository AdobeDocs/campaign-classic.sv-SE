...
Läs mer om [spårningsloggar i Campaign v8](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracking-logs){target="_blank"} eller [v7-specifik spårning](../../delivery/using/about-message-tracking.md).
+++
