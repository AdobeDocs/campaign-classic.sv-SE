...
Läs mer om godkännande av filextrahering i [dokumentationen för Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/direct-mail.html?lang=sv-SE#validating){target="_blank"}.
+++
...
Läs mer om [spårningsloggar](../../delivery/using/accessing-the-tracking-logs.md).
+++
