...
1. Lägg till ytterligare data från frågan. Mer information finns i avsnittet [Lägga till data](../../workflow/using/query.md#adding-data).
   ...
   Välj **[!UICONTROL Add data...]** i **[!UICONTROL Query]**.
...
1. Välj **[!UICONTROL Data linked to the filtering dimension]** och markera sedan noden **[!UICONTROL Recipient delivery logs]** och klicka på **[!UICONTROL Next]**.
...
1. Definiera utdatakolumner. Här är den enda kolumn som behövs en som räknar antalet leveranser. Så här gör du:
   ...
   * Klicka på **[!UICONTROL Finish]** och spara aktivitetskonfigurationen för **[!UICONTROL Query]**.
...
Om ett fel inträffar för aktiviteten **[!UICONTROL List update]** betyder det att synkroniseringen med Campaign Standarden kan ha misslyckats. Om du vill ha mer information om vad som gick fel går du till **[!UICONTROL Administration]** > **[!UICONTROL ACS Connector]** > **[!UICONTROL Process]** > **[!UICONTROL Diagnosis]**. Den här mappen innehåller synkroniseringsarbetsflöden som utlöses av aktivitetskörningen **[!UICONTROL List update]**. Se avsnittet [Felsökning av ACS Connector](../../integrations/using/troubleshooting-the-acs-connector.md).
...
När målarbetsflödet körs i Campaign v7 kan du hitta listmålgruppen i skrivskyddat läge på **[!UICONTROL Audiences]**-menyn i Campaign Standarden.
