...
seo-title: Synkronisera publiker
...
1. Lägg till en **[!UICONTROL Query]** aktivitet och välj de mottagare som du vill skicka det slutliga e-postmeddelandet till. Till exempel alla mottagare mellan 18 och 30 år och bor i Frankrike.

   ![](assets/acs_connect_query1.png)

1. Lägg till ytterligare data från frågan. For more information, refer to the [Adding data](../../workflow/using/query.md#adding-data) section.
...
Om ett fel inträffar i **[!UICONTROL List update]** aktiviteten innebär det att synkroniseringen med Campaign Standarden kan ha misslyckats. Om du vill se mer information om vad som gick fel går du till **[!UICONTROL Administration]** > **[!UICONTROL ACS Connector]** > **[!UICONTROL Process]** > **[!UICONTROL Diagnosis]**. Den här mappen innehåller synkroniseringsarbetsflöden som utlöses av **[!UICONTROL List update]** aktivitetskörningen. Se avsnittet [Felsöka ACS Connector](../../integrations/using/troubleshooting-the-acs-connector.md) .
...
När målarbetsflödet körs i Campaign v7 kan du hitta målgruppen i skrivskyddat läge på Campaign Standardens **[!UICONTROL Audiences]** meny.
...
1. Lägg till ett personaliseringsfält.  Leta reda på **[!UICONTROL Additional data (targetData)]** noden på popup-menyn. Den här noden innehåller ytterligare data om målgruppen som beräknades i det inledande målarbetsflödet. Du kan använda dem som vilket annat personaliseringsfält som helst.
