---
product: campaign
title: Konfigurera Developer Console för Adobe Experience Cloud-utlösare
description: Lär dig hur du konfigurerar Developer Console Experience Cloud-utlösare
feature: Triggers
...
# Konfigurera Developer Console för Adobe Experience Cloud-utlösare {#configuring-adobe-io}
...
* en giltig **organisationsidentifierare**: Organisations-ID är den unika identifieraren inom Adobe Experience Cloud, som används t.ex. för VisitorID-tjänsten och IMS Single-Sign On (SSO). [Läs mer](https://experienceleague.adobe.com/docs/core-services/interface/administration/organizations.html?lang=sv-SE)
...
>
> * Om ni har implementerat utgående integreringar, som integrering med Campaign-Analytics eller integrering med Experience Cloud Triggers, fortsätter de att fungera fram till 27 januari 2025. Innan detta datum måste ni dock uppgradera er Campaign-miljö till v7.4.1 och migrera ert tekniska konto till Autentisering.
