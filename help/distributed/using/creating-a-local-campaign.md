...
Skapa kampanjarbetsflödet som samlar in **[!UICONTROL Default values]** som anges i **[!UICONTROL Advanced campaign settings...]** och skapar leveranserna på fliken **[!UICONTROL Targeting and workflows]**.
