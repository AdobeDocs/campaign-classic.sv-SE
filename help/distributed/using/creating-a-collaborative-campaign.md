...
Om du vill konfigurera en samarbetskampanj klickar du på noden **[!UICONTROL Campaign management > Campaigns]** och sedan på ikonen **[!UICONTROL New]** .
...
Klicka på länken **[!UICONTROL Advanced campaign settings...]** på fliken **[!UICONTROL Edit]** för att komma åt fliken **Distribuerad marknadsföring**.
