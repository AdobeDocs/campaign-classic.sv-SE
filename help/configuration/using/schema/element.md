...
* **mängd (sträng)**: Med kan du kopiera definitionen av ett  `<element>`  via ett annat schema. Det här attributet tar emot en schemadeklaration i form av en &quot;namespace:name&quot;.
