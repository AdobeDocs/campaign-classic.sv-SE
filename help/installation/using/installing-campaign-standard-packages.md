...
badge-v7-prem: label="Endast lokal/hybrid" type="Caution" url="https://experienceleague.adobe.com/docs/campaign-classic/using/installing-campaign-classic/architecture-and-hosting-models/hosting-models-lp/hosting-models.html" tooltip="Gäller endast lokala och hybrida driftsättningar"
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Innehåller ytterligare funktionalitet som kan hjälpa dig att följa Campaign Classic sekretesskrav. <a href="https://helpx.adobe.com/campaign/kb/acc-privacy.html">Läs mer</a> <br /> </td> 
   <td> Alla</td> 
  </tr> 
  <tr> 
