...
1. Klicka på **[!UICONTROL Explorer]** / **[!UICONTROL Administration]** / **[!UICONTROL Platform]** i Campaign **[!UICONTROL External accounts]**.
...
1. Använd **[!UICONTROL Default]** för att ange ett standardfrågeband som ska användas om en användare inte har något associerat frågeband. Om det här fältet lämnas tomt kan inte användare utan frågeband använda Teradata.
...
Felet **ODB-240000 ODBC-fel: \[Microsoft\]\[ODBC Driver Manager\] Datakällans namn hittades inte och ingen standarddrivrutin har angetts.** inträffar med Windows om du använder en 16.X-drivrutin. Adobe Campaign förväntar sig att teradata får namnet {teradata} i odbcinst.ini.
...
Om du vill använda udf_utf16to8-funktioner i din Adobe Campaign-instans installerar du användarlägesfunktionen i din Teradata-databas från **Teradata Unicode-verktygslådan**.
...
* Teradata ODBC-drivrutin som finns på [sidan](https://downloads.teradata.com/download/connectivity/odbc-driver/linux)
