...
1. Lägg till aktiviteterna **Filinsamlaren** och **Datainläsning (fil)** i arbetsflödet.
   ...
   Med aktiviteten **Filinsamlaren** kan du samla in och skicka filer från och till Adobe Campaign-servern.
...
1. Konfigurera aktiviteten **Filinsamlaren** för att samla in textfiler (*.txt) från den valda katalogen.
   ...
   Med aktiviteten **Filinsamlaren** kan du hantera frånvaron av en fil i källkatalogen. Det gör du genom att markera alternativet **[!UICONTROL Process file nonexistence]**. I det här arbetsflödet har en **Wait**-aktivitet lagts till för att försöka med en annan filsamling om den saknas i katalogen vid tidpunkten för samlingen.
...
1. Konfigurera aktiviteten **Datainläsning (fil)** med en exempelfil med samma format som de data som ska importeras.
   ...
   Klicka på länken **[!UICONTROL Click here to change the file format...]** för att byta namn på kolumnerna med hjälp av de interna namnen och etiketterna i tabellen&quot;Inköp&quot;.
...
En avstämning mellan data i arbetsflödets arbetstabell och måldimensionen **Inköp** måste göras innan data i tabellen **Inköp** uppdateras.
...
1. Välj **[!UICONTROL By directly using the targeting dimension]**-värdet för alternativet **[!UICONTROL Record identification]**.
1. Välj schemat&quot;Inköp&quot; som **[!UICONTROL Document type]**.
1. Ange listan med fält som ska uppdateras. Med kolumnen **[!UICONTROL Destination]** kan du definiera fälten i schemat&quot;Inköp&quot;. Med kolumnen **[!UICONTROL Expression]** kan du markera de fält i arbetstabellen som ska utföra en mappning.
...
1. Lägg till en **fråga**-typaktivitet som gör att du kan återställa alla lagrade **kontakter**.
1. Lägg till en **Enrichment**-aktivitet och välj sedan den huvuduppsättning som är resultatet av föregående fråga.
...
1. Lägg till en **listuppdatering**-aktivitet i arbetsflödet. Denna verksamhet måste vara kopplad till den utgående övergången för den andra anrikningsaktiviteten.
