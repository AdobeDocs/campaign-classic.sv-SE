...
## Samla in data {#how-to-collect-data}
...
Den här listan kan ha skapats direkt i Adobe Campaign eller importerats med alternativet **[!UICONTROL Import a list]**. Mer information om det här alternativet finns på den här [sidan](../../platform/using/generic-imports-and-exports.md).

Mer information om hur du använder aktiviteten för läslista i ett arbetsflöde finns i [Läslista](../../workflow/using/read-list.md).
...
### Läser in data i grupp från filer {#loading-data-in-batch-from-files}
...
Använd alltid aktiviteten **[!UICONTROL Data Loading (File)]** i arbetsflöden för datahantering för att få bättre effektivitet.
...
## Zippa upp eller dekryptera en fil innan {#unzipping-or-decrypting-a-file-before-processing} bearbetas

### Om förbearbetningssteg {#about-pre-processing-stages}
