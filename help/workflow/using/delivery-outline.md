...
Mer information om leveransdispositioner i Adobe Campaign finns i [avsnittet](../../campaign/using/marketing-campaign-deliveries.md#associating-and-structuring-resources-linked-via-a-delivery-outline).
...
Med aktiviteten **leveransdisposition**, som är tillgänglig i kampanjarbetsflödena, kan du presentera erbjudanden som refereras i en leveransdisposition från den aktuella kampanjen.
...
1. Det finns två möjliga fall:
   ...
   * Om du vill ringa erbjudandemotorn markerar du rutan **[!UICONTROL Restrict the number of propositions selected]**. Ange erbjudandeutrymme och antalet offerter som ska presenteras i leveransen.
