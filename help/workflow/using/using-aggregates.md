...
1. På fliken **[!UICONTROL Links]** lägger du till en ny länk och anger informationen i fönstret som öppnas enligt följande:
   ...
   * Ange slutligen att länken är **[!UICONTROL Type 11 simple link]**.
...
1. På fliken **[!UICONTROL subsets]** väljer du **[!UICONTROL Add a filtering condition on the inbound population]** och klickar sedan på **[!UICONTROL Edit...]**.
