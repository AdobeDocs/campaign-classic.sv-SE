...
Upptäck fler sätt att övervaka Campaign-processer på [den här sidan](../../production/using/monitoring-guidelines.md).
...
>[!NOTE]
>
>Utöver **heatmap för arbetsflöde** kan du skapa ett arbetsflöde där du kan övervaka statusen för en uppsättning arbetsflöden och skicka återkommande meddelanden till ansvariga. Mer information finns i det [dedikerade avsnittet](supervising-workflows.md).

Om du använder HeatMap-arbetsflödet måste du ha god förståelse för följande koncept: [Arbetsflöden](about-workflows.md), [Aktiviteter](about-activities.md) och [Bästa arbetsflöden](workflow-best-practices.md).
...
1. Du kan även filtrera på **[!UICONTROL Workflow type]**:
   ...
   * **[!UICONTROL Technical]** : Endast [färdiga arbetsflöden](building-a-workflow.md#technical-workflows) och [arbetsflöden för datahantering](targeting-data.md#data-management) visas.
   * **[!UICONTROL Marketing]** : Endast arbetsflöden som är länkade till en marknadsföringskampanj, så kallade [kampanjarbetsflöden](building-a-workflow.md#campaign-workflows), visas.
