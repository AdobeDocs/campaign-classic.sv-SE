...
1. Markera de samlingar som ska flyttas till den primära posten och de fält som ska uppdateras.
   ...
   Ange de regler som gäller för dessa när en eller flera sekundära poster identifieras. Du kan använda uttrycksverktyget för att göra detta. Mer information finns i [avsnittet](../../platform/using/adobe-campaign-workspace.md#about-queries-in-campaign). Genom att till exempel ange att det är det senast uppdaterade värdet av alla olika poster som måste behållas.
...
[Steg 2: Skriver anrikade data till avsnittet Inköpsregister](creating-a-summary-list.md#step-2--writing-enriched-data-to-the--purchases--table) i användningsexemplet där detaljerad information om hur du skapar en sammanfattning ger ett exempel på en datauppdatering efter en anrikningsaktivitet.
