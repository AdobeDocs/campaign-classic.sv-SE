...
* Skapandeschemat: se [Körningsschema](#execution-schedule).
...
När en Adobe Campaign-operator skapar en uppgift tilldelas den som standard automatiskt. Använd fältet **[!UICONTROL Assigned to]** om du vill välja en annan operator.
...
Klicka på **[!UICONTROL Ok]** och ange sedan användningsgraden: detta representerar den belastning som tilldelats operatorn under aktivitetens varaktighet. Denna procentsats är endast en indikation och uttrycks som en procentandel.
...
Mer information finns i [Skapa en tjänstleverantör och dess kostnadskategorier](../../campaign/using/providers-stocks-and-budgets.md#creating-a-service-provider-and-its-cost-categories).
...
>[!NOTE]
>
>Metoden för att hantera budgetar och kostnader visas i [Kontrollkostnader](../../mrm/using/controlling-costs.md).
