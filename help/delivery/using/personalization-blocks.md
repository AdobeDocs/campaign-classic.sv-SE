...
Du kan inkludera källkoden för ett personaliseringsblock i leveransinnehållet. Gör detta genom att välja **[!UICONTROL Include the HTML source code of the block]** när du markerar den.
...
* **[!UICONTROL Insert logo]** : infogar en logotyp som inte finns i paketet och som har definierats när instansen konfigureras.
...
* **[!UICONTROL Registration link (with referrer)]** : infogar en prenumerationslänk som gör att besökaren och leveransen kan identifieras. Länken har definierats när instansen konfigureras.
