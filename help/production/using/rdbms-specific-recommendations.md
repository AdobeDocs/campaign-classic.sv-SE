...
>[!NOTE]
>
>För Microsoft SQL Server kan du använda underhållsplanen som beskrivs [på den här sidan](http://ola.hallengren.com/sql-server-index-and-statistics-maintenance.html).
