...
+ Kom igång {#getting-started}
   ...
   + [Ordlista - DOLD](platform/using/ac-glossary.md)
   + Integritet {#privacy}
      ...
      + Sekretessförfrågningar {#privacy-requests}
         + [Om sekretessförfrågningar](platform/using/privacy-requests.md)
         + [Skapa och hantera sekretessförfrågningar](platform/using/privacy-requests-ui.md)
         + [Automatisk process för begäran om sekretess](platform/using/privacy-requests-api.md)
      + [Avanmäl dig till försäljning av personuppgifter](platform/using/privacy-requests-ccpa.md)
   ...
   + CRM-anslutningar {#connectors}
      ...
      + [Anslut med Microsoft Dynamics 365](platform/using/crm-ms-dynamics.md)
...
+ Skapa och skicka meddelanden {#sending-messages}
   ...
   + Använd dirigerade adresser {#using-seed-addresses}
      ...
      + [Använd skiftläge: välj startadresser på villkor](delivery/using/use-case-selecting-seed-addresses-on-criteria.md)
...
+ Samordna marknadsföringskampanjer {#orchestrating-campaigns}
   ...
   + Om marknadsföringskampanjer {#about-marketing-campaigns}
      ...
      + [Få tillgång till marknadsföringskampanjer - DOLD](campaign/using/accessing-marketing-campaigns.md)
...
+ Svarshanteraren {#response-manager}
   + [Kom igång med svarshanteraren](response/using/about-response-manager.md)
   + [Konfiguration](response/using/configuration.md)
   + [Översiktsmallar](response/using/hypothesis-templates.md)
   + [Skapa hypoteser](response/using/creating-hypotheses.md)
   + [Spårning av hyposer](response/using/hypothesis-tracking.md)
+ Utforma och dela rapporter {#reporting}
   + Kom igång med rapporter {#reporting-in-adobe-campaign}
   ...
   + Få tillgång till inbyggda rapporter {#accessing-built-in-reports}
   ...
   + [Utforma rapporter med kuber](reporting/using/ac-cubes.md)
+ Designa webbinnehåll {#designing-content}
   + Webbprogram {#web-applications}
      ...
      + [Designa ett webbprogram](web/using/designing-a-web-application.md)
   ...
   + Redigera HTML-innehåll {#editing-html-content}
      + [Kom igång med HTML Editor](web/using/about-campaign-html-editor.md)
...
+ Skapa onlineundersökningar {#online-surveys}
   + [Kom igång med enkäter](surveys/using/about-surveys.md)
   + [Viktiga steg för att skapa en enkät](surveys/using/getting-started-with-surveys.md)
   + [Utforma en enkät](surveys/using/building-a-survey.md)
   + [Hantera svar](surveys/using/managing-answers.md)
   + [Publicera, spåra och använda insamlade data](surveys/using/publish-track-and-use-collected-data.md)
   + [Konfigurera enkäter](surveys/using/configuring-surveys.md)
...
+ Integrera med Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
   + [Kom igång med Campaign-integreringar](integrations/using/about-campaign-integrations.md)
   + [Skapa ett Adobe-konto](integrations/using/oauth-technical-account.md)
   + Adobe Experience Cloud-utlösare {#experience-triggers}
   ...
   + Adobe Analytics Connector{#analytics-connector}
      ...
      + [Adobe Analytics Connector-etablering](integrations/using/adobe-analytics-provisioning.md)
...
+ Automatisera med arbetsflöden {#automating-with-workflows}
   ...
   + Aktiviteter för målgruppsanpassning {#targeting-activities}
      ...
      + [Erbjudandemotor - DOLD](workflow/using/offer-engine.md)
   ...
   + Datahantering {#data-management}
      ...
      + [Förbättra data - DOLD](workflow/using/enriching-data.md)
...
+ Hantera erbjudanden {#managing-offers}
   ...
   + Enhetliga interaktioner {#unitary-interactions}
      ...
      + [Integrering via JavaScript (klientsidan)](interaction/using/integration-via-javascript-client-side.md)
   ...
   + Använd skiftläge {#case-study}
      ...
      + [Erbjudanden på utgående kanaler](interaction/using/offers-on-an-outbound-channel.md)
+ Transactional Messaging {#transactional-messaging}
   ...
   + Bearbetning av transaktionshändelser {#processing}
   ...
   + [Använd skiftläge](message-center/using/transactional-email-with-attachments.md)
...
+ Installations- och konfigureringshandbok {#installing-campaign-classic}
   + Arkitekturprinciper {#architecture-and-hosting-models}
      ...
      + Värdmodeller{#hosting-models-lp}
   ...
   + Säkerhets- och sekretessinställningar {#security-privacy}
      ...
      + [Personalization och integritet](installation/using/privacy.md)
   ...
   + Installera Campaign (lokalt){#install-campaign-on-prem}
      ...
      + Campaign i Linux {#installing-campaign-in-linux}
         + [Förutsättningar](installation/using/prerequisites-of-campaign-installation-in-linux.md)
   ...
   + Konfigurera kampanj {#additional-configurations}
      + [Kampanjserverkonfiguration](installation/using/configuring-campaign-server.md)
   ...
   + Tillägg {#appendices}
      ...
      + [Lista med kampanjalternativ](installation/using/configuring-campaign-options.md)
...
+ Övervakningshandbok {#monitoring-campaign-classic}
   ...
   + Produktionsförfaranden {#production-procedures}
      + [Konfiguration](production/using/configuration-principle.md)
   ...
   + Felsökning {#troubleshooting-toc}
      ...
      + Vanliga och allmänna frågor {#common-general-issues-toc}
      ...
      + Felsökning av leverans {#delivery-troubleshooting-toc}
      ...
      + Förbättrade anslutningsmöjligheter {#connection-improvements-toc}
...
+ Utvecklarhandbok {#configuring-campaign-classic}
   ...
   + Redigera scheman {#editing-schemas}
      ...
      + [Exempel på schemautgåva](configuration/using/examples-of-schemas-edition.md)
...
+ Migreringsguide {#migrating-to-a-new-version}
   ...
   + Migreringsprocedur {#migration-procedure}
      + [Förutsättningar](migration/using/before-starting-migration.md)
...
+ Technotes {#technotes}
   ...
   + [Inkommande SMS-arbetsflödesaktivitet för infrastruktur med mellanleverantörer](technotes/using/inbound-sms-wf.md)
   ...
   + Uppgraderingar och kompatibilitet{#technote-migration}
      ...
      + [Ny leveransserver](technotes/using/deliverability-server.md)
   ...
   + Mejl och push-meddelanden{#technotes-email}
      + [Sekretesskydd för e-post i Apple iOS](technotes/using/apple-mail-app-privacy-protection.md)
      ...
      + [iOS certifikatuppdatering](technotes/using/ios-certificate-update.md)
