...
+ Skapa och skicka meddelanden {#sending-messages}
   ...
   + Bästa praxis för leverans {#delivery-bestpractices}
      + [Optimera leveransen – DOLD](delivery/using/optimize-delivery.md)
   ...
   + Skicka push-meddelanden {#sending-push-notifications}
      ...
      + Konfigurera den mobila applikationen{#configure-the-mobile-app}
         + [Kom igång med konfigurationen av appen – DOLD](delivery/using/get-started-app-config.md)
   ...
   + Skicka direktreklam {#sending-direct-mail}
      + [Skapa en leverans av direktreklam – DOLD](delivery/using/creating-a-direct-mail-delivery.md)
      + [Definiera innehållet i direktreklamen – DOLD](delivery/using/defining-the-direct-mail-content.md)
   ...
   + Personanpassa leveranser {#personalizing-deliveries}
      ...
      + [Personanpassade kuponger – DOLDA](delivery/using/personalized-coupons.md)
      + [Generera personaliserade PDF-dokument – DOLD](delivery/using/generating-personalized-pdf-documents.md)
...
+ Orkestrera marknadsföringskampanjer {#orchestrating-campaigns}
   ...
   + Om marknadsföringskampanjer {#about-marketing-campaigns}
      ...
      + [Åtkomst till marknadsföringskampanjer – DOLD](campaign/using/accessing-marketing-campaigns.md)
   + Orkestrera kampanjer {#orchestrate-campaigns}
      ...
      + [Välj målgruppen – DOLD](campaign/using/marketing-campaign-target.md)
      + [Hantera dokument och resurser – DOLD](campaign/using/marketing-campaign-assets.md)
      + [Ange och hantera godkännanden – DOLD](campaign/using/marketing-campaign-approval.md)
      + [Övervaka dina kampanjer – DOLD](campaign/using/marketing-campaign-monitoring.md)
      + [Leverantörer, lager och budgetar – DOLD](campaign/using/providers-stocks-and-budgets.md)
   + Kampanjoptimering {#campaign-optimization}
      ...
      + [Tillämpa regler – DOLD](campaign-opt/using/applying-rules.md)
      + [Kampanjsimuleringar – DOLD](campaign-opt/using/campaign-simulations.md)
+ Hantera marknadsföringsresurser {#mrm}
   + [Om hantering av marknadsföringsresurser – DOLD](mrm/using/about-marketing-resource-management.md)
   + [Skapa och hantera uppgifter – DOLD](mrm/using/creating-and-managing-tasks.md)
   + [Kontrollkostnader – DOLD](mrm/using/controlling-costs.md)
   + [Hantera marknadsföringsresurser – DOLD](mrm/using/managing-marketing-resources.md)
   + [Diskussionsfora – DOLD](mrm/using/discussion-forums.md)
+ Distribuerad marknadsföring {#distributed-marketing}
   ...
   + [Skapa en samverkanskampanj – DOLD](distributed/using/creating-a-collaborative-campaign.md)
   + [Publicera kampanjpaketet – DOLD](distributed/using/publishing-the-campaign-package.md)
   + [Åtkomstkampanjer – DOLD](distributed/using/accessing-campaigns.md)
...
+ Automatisera med arbetsflöden {#automating-with-workflows}
   + Kom igång med arbetsflöden {#introduction}
      ...
      + [God praxis för arbetsflöden – DOLD](workflow/using/workflow-best-practices.md)
   + Kör ett arbetsflöde {#executing-a-workflow}
      ...
      + [Datas livscykel – DOLD](workflow/using/data-life-cycle.md)
   ...
   + Aktiviteter för målgruppsanpassning {#targeting-activities}
      ...
      + [Sammanslutning – DOLD](workflow/using/union.md)
      ...
      + [Leveransdisposition – DOLD](workflow/using/delivery-outline.md)
   ...
   + Flödeskontrollaktiviteter {#flow-control-activities}
      ...
      + [Starta och sluta – DOLD](workflow/using/start-and-end.md)
      + [Gaffel – DOLD](workflow/using/fork.md)
      + [AND-join – DOLD](workflow/using/and-join.md)
      + [Schemaläggare – DOLD](workflow/using/scheduler.md)
      + [Test – DOLD](workflow/using/test.md)
      + [Vänta – DOLD](workflow/using/wait.md)
      + [Tidsbegränsning – DOLD](workflow/using/time-constraint.md)
   ...
   + Åtgärdsaktiviteter {#action-activities}
      + [Om åtgärdsaktiviteter – DOLD](workflow/using/about-action-activities.md)
      ...
      + [Tvärkanalsleveranser – DOLD](workflow/using/cross-channel-deliveries.md)
      + [Lokalt godkännande – DOLD](workflow/using/local-approval.md)
      + [Datainläsning (RDBMS) – DOLD](workflow/using/data-loading-rdbms.md)
      + [Inläsning (SOAP) – DOLD](workflow/using/loading-soap.md)
      + [Datainläsning (fil) – DOLD](workflow/using/data-loading-file.md)
      ...
      + [SQL-datahantering – DOLD](workflow/using/sql-data-management.md)
      + [Nlserver-modul – DOLD](workflow/using/nlserver-module.md)
      + [Uppdatera aggregat – DOLD](workflow/using/update-aggregate.md)
   + Händelseaktiviteter {#event-activities}
      + [Om händelseaktiviteter – DOLD](workflow/using/about-event-activities.md)
      + [Filhämtare – DOLD](workflow/using/file-collector.md)
   ...
   + Användningsfall {#use-cases}
      ...
      + Leveranser {#deliveries}
         + [Använda den lokala godkännandeaktiviteten – DOLD](workflow/using/using-the-local-approval-activity.md)
         + [Skicka ett födelsedagsmeddelande via e-post – DOLD](workflow/using/sending-a-birthday-email.md)
         + [Läs in leveransinnehåll – DOLD](workflow/using/loading-delivery-content.md)
         + [Arbetsflöde för tvärkanalsleveranser – DOLD](workflow/using/cross-channel-delivery-workflow.md)
         + [E-postberikande med anpassade datumfält – DOLD](workflow/using/email-enrichment-with-custom-date-fields.md)
   + Övervakning {#monitoring}
      ...
      + [Skicka personanpassade aviseringar till operatörer – DOLD](workflow/using/sending-personalized-alerts-to-operators.md)
   + Datahantering {#data-management}
      ...
      + [Berika data – DOLD](workflow/using/enriching-data.md)
      + [Användningsaggregat – DOLD](workflow/using/using-aggregates.md)
      + [Använd funktionen för att sammanfoga dedupliceringsaktiviteten – DOLD](workflow/using/deduplication-merge.md)
   ...
   + Fråga och filtrera {#query-and-filter-hidden}
      ...
      + [Fråga med en många-till-många-relation – DOLD](workflow/using/querying-using-many-to-many-relationship.md)
   ...
   + Övervaka arbetsflöden {#monitoring-workflows}
      + [Övervaka arbetsflödeskörning – DOLD](workflow/using/monitoring-workflow-execution.md)
   ...
   + Avancerad hantering {#advanced-management}
      ...
      + [Hantera profiler – DOLD](workflow/using/managing-rights.md)
