...
>[!CAUTION]
>Campaign **[!UICONTROL Help > About...]** kan du kontrollera [version och build-nummer](../../platform/using/launching-adobe-campaign.md#getting-your-campaign-version). Observera dock att för alla byggen mellan 9277 och 9343 som listas på den här sidan visar versionsnumret 7.0 i stället för 7.1.
