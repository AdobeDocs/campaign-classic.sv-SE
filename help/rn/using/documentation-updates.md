...
Uppdaterade **Filöverföring** aktivitetsavsnittet med en påminnelse om att manuellt övervaka storleken på det arkiverade innehållet i SFTP-katalogen om **Ta bort källfilerna efter överföringen** alternativet är inte markerat. [Läs mer](../../workflow/using/file-transfer.md#properties)
...
[Campaign version 20.2.3](../../rn/using/release--2020.md#release-20-2-3-build-9182) har flyttats till Allmän tillgänglighet (GA).
...
Starthandböckerna [Säkerhet](https://experienceleague.adobe.com/docs/campaign-classic/using/installing-campaign-classic/security-privacy/get-started-security-privacy.html?lang=sv), [Leverans](../../delivery/using/about-deliverability.md) och [Sekretess](../../platform/using/privacy-management.md) har uppdaterats.
