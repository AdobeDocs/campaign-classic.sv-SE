...
* Från och med Campaign 21.1 är Adobe Analytics Data Connector inaktuell. Om du använder den här anslutningen måste du anpassa implementeringen med den nya anslutningen Adobe Analytics Connector.
