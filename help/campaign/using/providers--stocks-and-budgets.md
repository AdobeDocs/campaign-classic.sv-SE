...
1. Högerklicka på listan över tjänsteleverantörer och välj **[!UICONTROL New]** eller klicka på **[!UICONTROL New]** ovanför listan över tjänsteleverantörer.
...
1. I **[!UICONTROL Services]** klickar du på **[!UICONTROL Add]** och namnge tjänstmallen.
...
Klicka på **[!UICONTROL Create]** för att definiera parametrar.
...
När du väljer budget i en kampanj måste du ange det ursprungliga beloppet. De beräknade kostnaderna uppdateras automatiskt i enlighet med åtagandenivån för de angivna beloppen (utgifter som gjorts, förväntades, reserverades, gjordes). Se [Beräknar belopp](../../mrm/using/controlling-costs.md#calculating-amounts).

>[!NOTE]
>
>Hur man skapar budgetar beskrivs i [Skapa en budget](../../mrm/using/controlling-costs.md#creating-a-budget).
