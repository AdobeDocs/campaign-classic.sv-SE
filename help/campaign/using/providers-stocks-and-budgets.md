...
Tjänstproviders är konfigurerade i noden **[!UICONTROL Administration > Campaign management]** i trädet.
...
1. Klicka på knappen **[!UICONTROL Add]** på fliken **[!UICONTROL Services]** i tjänsteleverantören och ge tjänstmallen ett namn.
...
1. Skapa kostnadskategorier för varje typ av process (direktreklam/e-post/etc.). eller uppgift). Det gör du genom att klicka på fliken **[!UICONTROL Cost categories]** och sedan på knappen **[!UICONTROL Add]** och ange parametrarna för varje kostnadskategori.
   ...
   * Ange en etikett för kostnadskategorin och välj typ av process: Leverans av **[!UICONTROL Direct mail]**, **[!UICONTROL Email]**, **[!UICONTROL Mobile]**, **[!UICONTROL Telephone]** eller **[!UICONTROL Task]**.
...
1. Du kan i förväg välja ett värde för den här kostnadskategorin, som erbjuds som standard i tjänsteleverantörens kostnadskategorier (i stället för ett tomt värde). Det gör du genom att välja alternativet i kolumnen **[!UICONTROL Selected]** för den aktuella typen av kategori:
...
1. Ange Stock-etiketten och välj den tjänsteleverantör som den är associerad med i listrutan.
   ...
   >[!NOTE]
   >
   >Mer information finns i [Skapa tjänstleverantörer och deras kostnadsstrukturer](#creating-service-providers-and-their-cost-structures).
...
Klicka på knappen **[!UICONTROL Create]** för att definiera parametrar för Stock.
