...
### Transaktionstabeller och transaktionsinformation {#transaction-tables-and-transaction-details}
...
* Skapar ett nytt svarsloggsschema som härleds från **[!UICONTROL nms:remaMatch]**-schemat.
